...
export function QuestionSection({ topicName, onBack }: QuestionSectionProps) {
  ...
  const handlePreview = () => {
    ...
    try {
      console.log("[v0] Attempting to navigate to /question-bank/preview")
      router.push("/question-bank/preview")
      console.log("[v0] Router.push called successfully")
    } catch (error) {
      console.error("[v0] Error navigating to preview:", error)
    }
  }
  ...
  const handleAddQuestion = () => {
    ...
    try {
      console.log("[v0] Attempting to navigate to /question-bank/add-question")
      router.push("/question-bank/add-question")
      console.log("[v0] Router.push called successfully")
    } catch (error) {
      console.error("[v0] Error navigating to add question:", error)
    }
  }
  ...
  return (
    <div className="flex-1 p-4 bg-background min-h-screen">
      ...
      <EditTopicModal
        ...
        onSave={(updatedTopic) => {
          console.log("[v0] Topic updated:", updatedTopic)

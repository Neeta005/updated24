    ...
    <main className="flex-1 p-6">
      <div className="rounded-2xl bg-card border border-slate-700 p-4 md:p-6 space-y-6">
        ...
        <div className="rounded-xl border border-slate-700 overflow-hidden">
          ...
          {/* Builder Row */}
          <div className="px-4 py-4 grid grid-cols-12 gap-2 items-center border-t border-slate-700 bg-slate-800/90">
            {/* Search */}
            <div className="col-span-3">
              <input
            ...
            {/* Method column with Manual pill and Save button */}
            <div className="col-span-2 flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 bg-slate-700/50 px-2 py-1.5 rounded-full text-slate-200 text-sm">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-white">
                  <img src="/icons/Knob.png" alt="Manual Icon" className="h-3 w-3 object-contain" />
          ...
          <div className="px-4 pb-4 border-t border-slate-700 pt-4 bg-slate-800/90">
            <div className="flex justify-end">
              <button className="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-orange-primary to-red-primary px-3 py-2 text-white min-w-[40px] min-h-[40px]">

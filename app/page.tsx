...
export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-background to-muted px-6 text-center">
      ...
      <Text
        as="h1"
        className="text-4xl md:text-6xl font-extrabold tracking-tight text-card-foreground drop-shadow-lg"
      >
        Welcome to{" "}
      ...
      >
        ...
        Designed to give educators peace of mind and students a smooth
        experience.
      </Text>
